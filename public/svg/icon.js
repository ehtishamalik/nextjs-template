...
function Certificate({ className }) {
  return (
    <svg
      className={className}
      enableBackground="new 0 0 512.531 512.531"
      height="512"
      viewBox="0 0 512.531 512.531"
      width="512"
      xmlns="http://www.w3.org/2000/svg"
    >
    ...
    >
      ...
      <g>
        <g id="check-box-outline">
          <path
            d="M124.95,181.05l-35.7,35.7L204,331.5l255-255l-35.7-35.7L204,260.1L124.95,181.05z M408,408H51V51h255V0H51
...
function FileDoc({ className }) {
  return (
    <svg
      ...
      style={{ enableBackground: "new 0 0 588.601 588.6" }}
      xmlSpace="preserve"
    >
      <title>File Doc</title>
      <g>
        <path
          d="M181.285,256.98c-15.915,0.274-25.088,15.952-25.088,36.698c0,20.903,9.471,35.807,25.239,36.08
           c16.158,0.29,25.537-15.445,25.537-36.713C206.967,273.412,197.749,256.701,181.285,256.98z"
        />
        <path
          d="M68.262,259.221c-4.736,0.076-7.781,0.577-9.574,1.062v66.564c1.793,0.484,4.704,0.543,7.338,0.585
           c19.388,0.485,32.234-10.99,32.234-35.78C98.405,270.103,86.688,258.902,68.262,259.221z"
        />
        <path
          d="M359.031,537.78c0.781,0.042,1.551,0.111,2.342,0.111h178.2c20.846,0,37.8-16.96,37.8-37.801V86.994
        ...
        />
        <path
          d="M477.394,226.081l6.629-26.935c1.693-6.544,2.806-12.062,3.829-18.183h0.163c0.675,6.199,1.692,11.639,3.138,18.183
...
function FileMp3({ className }) {
  return (
    <svg
      ...
      style={{ enableBackground: "new 0 0 585.918 585.918" }}
      xmlSpace="preserve"
    >
      <title>File Mp3</title>
      <g>
        <path
          d="M195.365,245.863c-4.935,0.092-8.273,0.631-10.003,1.158V279.3c2.048,0.488,4.591,0.646,8.084,0.635
           c12.987-0.013,21.092-6.779,21.092-18.121C214.538,251.617,207.577,245.653,195.365,245.863z"
        />
        <path
          d="M357.396,535.325c0.776,0.052,1.542,0.114,2.329,0.114h177.39c20.75,0,37.627-16.883,37.627-37.627V86.597
        ...
        />
        <path
          d="M503.057,275.248c-5.502,0.563-6.068,4.23-6.068,4.23v83.183c-4.137-1.26-9.05-1.491-14.111-0.39
        ...
        />
        <path
          d="M441.375,264.169c-9.753,0-17.689,7.929-17.689,17.685c0,9.75,7.937,17.689,17.689,17.689
           c9.754,0,17.681-7.938,17.681-17.689C459.056,272.098,451.129,264.169,441.375,264.169z"
        />
        <path
          d="M441.375,248.014c-18.656,0-33.837,15.181-33.837,33.84c0,18.653,15.181,33.834,33.837,33.834
        ...
        />
        <path
          d="M515.444,310.476l-0.062,18.493c3.774-5.932,6.872-12.325,9.16-19.106c-2.798-1.711-5.35-2.846-7.564-3.57
...
function FileMp4({ className }) {
  return (
    <svg
      ...
      style={{ enableBackground: "new 0 0 588.6 588.6" }}
      xmlSpace="preserve"
    >
      <title>File Mp4</title>
      <g>
        <path
          d="M359.036,537.786c0.771,0.042,1.551,0.115,2.342,0.115h178.2c20.84,0,37.8-16.959,37.8-37.8v-413.1
        ...
        />
        <path
          d="M190.233,239.826c-4.97,0.087-8.321,0.643-10.083,1.163v32.566c2.078,0.49,4.627,0.644,8.153,0.644
           c13.081-0.023,21.223-6.848,21.223-18.291C209.526,245.621,202.523,239.609,190.233,239.826z"
        />
        <path
          d="M282.972,264.094l-15.103,24.284v0.34l25.471,0.124v-24.819c0-6.719,0.346-13.614,0.875-20.859l-0.695,0.011
           C289.81,250.464,286.833,257.025,282.972,264.094z"
        />
        <path
          d="M526.489,240.629H374.582v111.32h151.907V240.629z M483.742,297.517l-51.996,33.201c-0.284,0.222-0.622,0.338-0.97,0.338
        ...
        />
        <path
          d="M532.574,351.959h-6.085v1.735H374.582v-1.735h-5.505v27.19h163.497V351.959L532.574,351.959z M529.104,375.669H372.558
           V355.43h156.547V375.669z"
        />
        <path
          d="M526.489,238.892v1.737h6.085v-27.187H369.077v27.187h5.505v-1.737H526.489z M372.558,237.157V216.92h156.547v20.236
           H372.558z"
        />
...
function FilePdf({ className }) {
  return (
    ...
    >
      ...
      <g>
        <path
          d="M162.643,247.503c-5.719,0.084-9.384,0.654-11.549,1.213v75.774c2.16,0.554,5.674,0.617,8.849,0.68
           c23.382,0.623,38.908-12.413,38.908-40.666C199.019,259.933,184.886,247.164,162.643,247.503z"
        />
        <path
          d="M359.036,537.78c0.771,0.042,1.551,0.111,2.342,0.111h178.2c20.84,0,37.8-16.96,37.8-37.801V86.994
        ...
        />
        <path
          d="M67.745,248.622c-4.77,0.074-7.992,0.614-9.683,1.139v32.777c1.98,0.498,4.438,0.665,7.834,0.665
...
function FilePpt({ className }) {
  return (
    ...
    >
      ...
      <g>
        <path
          d="M357.396,535.33c0.776,0.042,1.542,0.109,2.329,0.109h177.39c20.75,0,37.627-16.883,37.627-37.627V86.597
        ...
        />
        <path
          d="M84.122,255.121c-4.738,0.086-7.93,0.63-9.596,1.155v32.57c1.963,0.488,4.396,0.65,7.756,0.64
           c12.438-0.023,20.191-6.833,20.191-18.266C102.474,260.938,95.817,254.916,84.122,255.121z"
        />
        <path
          d="M176.879,253.491c-5.145,0.087-8.622,0.662-10.422,1.205v33.966c2.139,0.512,4.779,0.672,8.428,0.672
...
function FileXls({ className }) {
  return (
    ...
    >
      ...
      <g>
        <path
          d="M11.176,46.207v492.31l346.22,47.401v-50.583c0.776,0.053,1.542,0.115,2.329,0.115h177.39
  ...
  return (
    ...
    >
      ...
      <g>
        ...
        />
        <path
          d="M247.554,250.715c-5.545,0.098-9.305,0.696-11.264,1.266v35.363c2.31,0.53,5.168,0.707,9.115,0.696
        ...
        <path
          d="M423.626,378.707c23.172,0,41.939-18.784,41.939-41.966l-7.736-70.284c0-23.172-11.031-41.958-34.203-41.958
...
function FiveStars({ className }) {
  return (
    <svg
      ...
      width="112.379px"
      height="19.38px"
      viewBox="0 0 112.379 19.38"
      enableBackground="new 0 0 112.379 19.38"
      xmlSpace="preserve"
    >
      <title>Five Stars</title>
      <polygon
        points="10.19,0 13.337,6.379 20.379,7.403 15.284,12.369 16.487,19.38 10.19,16.069 3.893,19.38 
            5.095,12.369 0,7.403 7.041,6.379 "
      />
      <polygon
        points="33.19,0 36.337,6.379 43.379,7.403 38.284,12.369 39.487,19.38 33.19,16.069 26.893,19.38 
            28.095,12.369 23,7.403 30.041,6.379 "
      />
      <polygon
        points="56.19,0 59.337,6.379 66.379,7.403 61.284,12.369 62.487,19.38 56.19,16.069 49.893,19.38 
            51.095,12.369 46,7.403 53.041,6.379 "
      />
      <polygon
        points="79.19,0 82.337,6.379 89.379,7.403 84.284,12.369 85.487,19.38 79.19,16.069 72.893,19.38 
            74.095,12.369 69,7.403 76.041,6.379 "
      />
      <polygon
        points="102.19,0 105.337,6.379 112.379,7.403 107.284,12.369 108.486,19.38 102.19,16.069 95.893,19.38 
...
function PlayVideo({ className }) {
  return (
    <svg
      ...
      style={{ enableBackground: "new 0 0 373.008 373.008" }}
      xmlSpace="preserve"
    >
      <title>Play Video</title>
      <path
        d="M61.792,2.588C64.771,0.864,68.105,0,71.444,0c3.33,0,6.663,0.864,9.655,2.588l230.116,167.2
  ...
  return (
    ...
    >
      ...
      <g>
        <g>
          <path
            d="M0.108,352.536c0,66.794,54.144,120.938,120.937,120.938c66.794,0,120.938-54.144,120.938-120.938
          ...
          />
          <path
            d="M266.169,352.536c0,66.794,54.144,120.938,120.938,120.938s120.938-54.144,120.938-120.938S453.9,231.599,387.106,231.599
...
function Quotes({ className }) {
  return (
    <svg
      ...
      style={{ enableBackground: "new 0 0 512.5 512.5" }}
      xmlSpace="preserve"
    >
      <title>Quotes</title>
      <path
        d="M112.5,208.25c61.856,0,112,50.145,112,112s-50.144,112-112,112s-112-50.145-112-112l-0.5-16
...
function Stars({ className }) {
  return (
    <svg
      ...
      width="637.035px"
      height="248.016px"
      viewBox="0 0 637.035 248.016"
      enableBackground="new 0 0 637.035 248.016"
      xmlSpace="preserve"
    >
      <title>Stars</title>
      <g>
        <g>
          ...
          <path
            ...
            d="M444.489,93.629c-0.528-1.632-1.94-2.823-3.64-3.066l-81.728-11.89L322.564,4.622
      ...
      <g>
        <g>
          ...
          <path
            ...
            d="M636.117,137.736c-0.378-1.166-1.386-2.017-2.6-2.19l-58.379-8.493l-26.113-52.896
      ...
      <g>
        <g>
          ...
          <path
            ...
            d="M180.117,137.736c-0.378-1.166-1.386-2.017-2.6-2.19l-58.379-8.493L93.025,74.158
               c-0.532-1.104-1.65-1.796-2.881-1.796c-1.229,0-2.347,0.692-2.898,1.796l-26.11,52.911l-58.379,8.478
               c-1.213,0.173-2.221,1.024-2.6,2.19c-0.378,1.166-0.063,2.458,0.819,3.309l42.245,41.178l-9.975,58.161
               c-0.205,1.189,0.283,2.417,1.276,3.142c0.992,0.733,2.314,0.822,3.403,0.237l52.218-27.447l52.221,27.447
               c0.455,0.252,0.975,0.378,1.494,0.378c0.663,0,1.341-0.205,1.892-0.615c0.994-0.725,1.497-1.952,1.292-3.142l-9.975-58.145
