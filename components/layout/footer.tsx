                ...
                <li>
                  <div className="item">
                    ...
                    <div className="textwidget">
                      <p>
                        We provide high-quality textile products designed for
                        comfort, durability and long-lasting performance. With a
                        focus on craftsmanship and service, we deliver reliable
                        solutions for homes, hospitals and businesses.
                      </p>
                    </div>
                  </div>
                </li>
                        ...
                        <ul>
                          <li>
                            <div className="day_item">
                              ...
                              <span className="hours">
                                <a
                                  href="mailto:info@zahometex.com"
                                  style={{
                                    color: "white",
                                    textDecoration: "none",
                                  }}
                          ...
                          <li>
                            <div className="day_item">
                              ...
                              <span className="hours">
                                <a
                                  href="mailto:Zaheer@zahometex.com"
                                  style={{
                                    color: "white",
                                    textDecoration: "none",
                                  }}
                                >
                                  Zaheer@zahometex.com
                                </a>
                              </span>
                            </div>
                          </li>
        ...
        <div className="container">
          <div className="footer_bottom_in">
            ...
            <div className="footer_copyright">
              <p>&copy; 2005 – 2025 Zohomatex, LCC. All rights reserved.</p>
            </div>
            {/* <ToTop /> */}
          </div>
        </div>
