                    ...
                    <div className="container">
                        <div className="footer_bottom_in">
                            ...
                            <div className="footer_copyright">
                                <p>&copy; 1934 – 2021 Industify, LCC. All rights reserved. Theme hecewas been developed by <Link href="https://themeforest.net/user/trendycoder"><a target="_blank" rel="noreferrer">TrendyCoder</a></Link></p>
                            </div>
                            <Link href="#">
